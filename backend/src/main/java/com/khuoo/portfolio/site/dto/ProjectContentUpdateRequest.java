...
import com.khuoo.portfolio.site.dto.ProjectContentResponse.DevelopmentItem;
import com.khuoo.portfolio.site.dto.ProjectContentResponse.EngineeringItem;
import com.khuoo.portfolio.site.dto.ProjectContentResponse.TitleItem;
...
public record ProjectContentUpdateRequest(
        ...
        List<@NotNull @Valid TitleItem> results,

        @NotNull
        @Schema(description = "문제 배경 문단 목록")
        List<@NotNull String> background,

        @NotNull
        @Schema(description = "주요 기능 목록")
        List<@NotNull @Valid TitleItem> features,
