...
public record ProjectContentUpdateResponse(
        @Schema(description = "프로젝트 성과 목록") List<ProjectContentResponse.ResultItem> results,
        @Schema(description = "문제 배경 항목") List<ProjectContentResponse.BackgroundItem> background,
        @Schema(description = "주요 기능 목록") List<ProjectContentResponse.FeatureItem> features,
