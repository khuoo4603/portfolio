...
public record AdminProjectResponse(
        ...
        @Schema(description = "프로젝트 연도", nullable = true) Short year,
        @Schema(description = "프로젝트 한 줄 설명", nullable = true) String tagline,
        @Schema(description = "프로젝트 카드 설명", nullable = true) String description,
        @Schema(description = "프로젝트 카드 역할", nullable = true) String cardRole,
