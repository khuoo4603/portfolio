...
export const PUBLIC_PORTFOLIO_FIXTURE: PublicPortfolio = {
  portfolioContents: [
    ...
    content("MAIN", "HERO_DESCRIPTION", "legacy description"),
  ...
  profileEntries: [
    ...
    { id: 9, entryType: "AWARD", periodText: "2021", title: "SW·AI 교육 수기 공모전", organization: null, role: null, description: null, achievement: "최우수상 · 과학기술정보통신부 장관상", displayOrder: 7 },
